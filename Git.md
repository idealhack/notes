...
- [基础知识（幻灯片）](https://speakerdeck.com/idealhack/introduction-to-git)
- [Windows 客户端](http://git-scm.com/download/win)
- [类似 TortoiseSVN 的 TortoiseGit](https://code.google.com/p/tortoisegit/)
- [SourceTree （GUI 客户端）](http://www.sourcetreeapp.com/)
...
- [A few git tips you didn't know about](http://mislav.net/2010/07/git-tips/)
- [git cheat sheet.pdf](https://s3-us-west-2.amazonaws.com/notion-static/HSmTMbNbSXGQPNJlMFuK_git%20cheat%20sheet.pdf)
- [Mastering Git Basic by Tom Preston-Werner.pdf](https://s3-us-west-2.amazonaws.com/notion-static/oxxekfvQDS9rbH7pPKZO_Mastering%20Git%20Basic%20by%20Tom%20Preston-Werner.pdf)
- [改进合作 Git 工作流：自动提取、合并提交 - 美团前端团队博客](http://fe.meituan.com/improving-git-flow_squashing-commits.html)
